...
VALUES
  ...
  ('fr', 'Linux', 'Quel lecteur multimédia ressemblant à « Winamp » est souvent utilisé sous Linux ?', 'XMMS', 'Mplayer', 'Tomahawk', 'Spotify', '3', 'XMMS fut codé sous le nom de « X11Amp » par Peter et Mikal Alm en novembre 1997, pour combler un manque sous GNU/Linux.', 'https://fr.wikipedia.org/wiki/XMMS'),
